...
'cookie_pre' => 'aakNd_', //Cookie 前缀，同一域名下安装多套系统时，请修改Cookie前缀
...
'errorlog' => 0, //是否保存错误日志
'gzip' => 1, //是否Gzip压缩后输出
'auth_key' => 'TB6WKBmz4bgGL20G2h4u', // //Cookie密钥
'lang' => 'zh-cn',  //网站语言包
'admin_founders' => '1', //网站创始人ID，多个ID逗号分隔
'execution_sql' => 0, //EXECUTION_SQL
//UCenter配置开始
'ucuse'=>'1',//是否开启UC
'uc_api'=>'http://localhost/userver',//Ucenter api 地址
...
'uc_dbtablepre'=>'\'ucenter\'.uc_',//Ucenter 数据库表前缀
'uc_dbcharset'=>'utf8',//Ucenter 数据库字符集
'uc_appid'=>'3',//应用id(APP ID)
'uc_key'=>'afcbW+0zmzEU5zDBhM/iojWB75kKlycOF9m+mt8',//Ucenter 通信密钥
);
?>